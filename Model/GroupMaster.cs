...
{    
    public class GroupMaster : IModel,INotifyPropertyChanged
    {
        ...
        #region IViewDetail Members
            public void FillDataFromDB(IDataRecord DBReader)
            {
                ...
                if (!DBReader.IsDBNull(DBReader.GetOrdinal("GroupName"))){
                    this.GroupName = DBReader.GetString(DBReader.GetOrdinal("GroupName"));
                }
        ...
        {  
            ...
            sXml.Append("<GroupName>" + this.GroupName + "</GroupName>");
        ...
        {  
            ...
            this.GroupName = objdata.GroupName;
        ...
        {  
            ...
            objdata.GroupName = this.GroupName;
