...
{    
    public class CityMaster : IModel,INotifyPropertyChanged
    {
        ...
        #region IViewDetail Members
            public void FillDataFromDB(IDataRecord DBReader)
            {
                ...
                if (!DBReader.IsDBNull(DBReader.GetOrdinal("InState"))){
                    this.InState = DBReader.GetString(DBReader.GetOrdinal("InState"));
                }
        ...
        {  
            ...
            sXml.Append("<InState>" + this.InState + "</InState>");
