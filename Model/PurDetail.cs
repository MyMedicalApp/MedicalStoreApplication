...
{    
    public class PurDetail : IModel,INotifyPropertyChanged
    {
        private long     nRecNo;
        public long     RecNo
        {
        ...
        private decimal     nCUser;
        public decimal     CUser
        {
            get { return nCUser; }
            set
            {
        ...
        #region IViewDetail Members
            public void FillDataFromDB(IDataRecord DBReader)
            {
                ...
                if (!DBReader.IsDBNull(DBReader.GetOrdinal("CUser"))){
                    this.CUser = DBReader.GetDecimal(DBReader.GetOrdinal("CUser"));
                }
