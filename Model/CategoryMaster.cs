...
{    
    public class CategoryMaster : IModel,INotifyPropertyChanged
    {
        ...
        #region IViewDetail Members
            public void FillDataFromDB(IDataRecord DBReader)
            {
                ...
                if (!DBReader.IsDBNull(DBReader.GetOrdinal("CategoryName"))){
                    this.CategoryName = DBReader.GetString(DBReader.GetOrdinal("CategoryName"));
                }
        ...
        {  
            ...
            sXml.Append("<CategoryName>" + this.CategoryName + "</CategoryName>");
        ...
        {  
            ...
            this.CategoryName = objdata.CategoryName;
        ...
        {  
            ...
            objdata.CategoryName = this.CategoryName;
