...
{    
    public class PatientMaster : IModel,INotifyPropertyChanged
    {
        private long     nPatientCode;
        public long     PatientCode
        {
            get { return nPatientCode; }
            set
            {
                nPatientCode = value;
        ...
        #region IViewDetail Members
            ...
            {
                if (!DBReader.IsDBNull(DBReader.GetOrdinal("PatientCode"))){
                    this.PatientCode = DBReader.GetInt64(DBReader.GetOrdinal("PatientCode"));
                }
                if (!DBReader.IsDBNull(DBReader.GetOrdinal("ICode"))){
                    this.ICode = DBReader.GetString(DBReader.GetOrdinal("ICode"));
                }
                if (!DBReader.IsDBNull(DBReader.GetOrdinal("PatientName"))){
                    this.PatientName = DBReader.GetString(DBReader.GetOrdinal("PatientName"));
                }
        ...
        {  
            ...
            sXml.Append("<data>");
            sXml.Append("<PatientCode>" + this.PatientCode + "</PatientCode>");
            sXml.Append("<ICode>" + this.ICode + "</ICode>");
            sXml.Append("<PatientName>" + this.PatientName + "</PatientName>");
        ...
        {  
            ...
            this.PatientCode = objdata.PatientCode;
            this.ICode = objdata.ICode;
            this.PatientName = objdata.PatientName;
        ...
        {  
            T obj = new T();
            PatientMaster objdata = obj as PatientMaster;
            objdata.PatientCode = this.PatientCode;
            objdata.ICode = this.ICode;
            objdata.PatientName = this.PatientName;
