...
{    
    public class GenericMaster : IModel,INotifyPropertyChanged
    {
        ...
        private string     sGenericName;
        public string     GenericName
        {
            get { return sGenericName; }
            set
            {
                sGenericName = value;
        ...
        #region IViewDetail Members
            public void FillDataFromDB(IDataRecord DBReader)
            {
                ...
                if (!DBReader.IsDBNull(DBReader.GetOrdinal("GenericName"))){
                    this.GenericName = DBReader.GetString(DBReader.GetOrdinal("GenericName"));
                }
                ...
                if (!DBReader.IsDBNull(DBReader.GetOrdinal("SchH1"))){
                    this.SchH1 = DBReader.GetString(DBReader.GetOrdinal("SchH1"));
                }
        ...
        {  
            ...
            sXml.Append("<GenericName>" + this.GenericName + "</GenericName>");
            ...
            sXml.Append("<SchH1>" + this.SchH1 + "</SchH1>");
