...
{    
     ...
     {    
            ...
            public DataBaseResultSet SaveBillMaster<T>(T objData) where T : class, IModel, new()
            {
                BillMaster obj = objData as BillMaster;
                string sQuery = "sprocBillMasterInsertUpdateSingleItem";
                List<DbParameter> list = new List<DbParameter>();
